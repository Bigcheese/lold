...
template <class Key,
          ...
          class Pred = std::equal_to<Key>,
          class Allocator = std::allocator<Key>>
class ConcurrentUnorderedSet : public ConcurrentUnorderedBase<ConcurrentUnorderedSetTraits<Key, Hash, Pred, Allocator>> {
  typedef ConcurrentUnorderedBase<ConcurrentUnorderedSetTraits<Key, Hash, Pred, Allocator>> BaseType;
